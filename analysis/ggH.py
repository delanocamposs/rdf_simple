...
#string to define the ID branch. easier than manually typing the mess into the phi mass loop.
...
#==========================================================================================================================
    ...
    #defining idnoiso cuts from custom loose ID H/E and sieie cuts.
