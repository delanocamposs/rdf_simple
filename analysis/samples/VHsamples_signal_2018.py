        ...
        for ct in [0, 10, 20, 50, 100, 1000]:
            for br in ['2G2Q','4G']:
                ...
                samples_signal_2018["{}H{}_M{}_ctau{}_2018".format(v, br, m, ct)] = {
                    'dataset': "local:root://cmsxrootd.fnal.gov//store/user/gfavila/DDP/UL2018/{}H_HTo2LongLivedTo{}_MH-125_MFF-{}_ctau-{}{}.root".format(v, br, m, ct,suffix),
    ...
    for ct in [0, 10, 20, 50, 100,1000]:
        for br in ['2G2Q','4G']:
            ...
            samples_signal_2018["ttH{}_M{}_ctau{}_2018".format(br, m, ct)] = {
                'dataset': "local:root://cmsxrootd.fnal.gov//store/user/gfavila/DDP/UL2018/ttH_ttSemiLep_HTo2LongLivedTo{}_MH-125_MFF-{}_ctau-{}mm{}.root".format(br, m, ct,suffix),
                'triggers': ['(HLT_IsoMu24||HLT_Ele32_WPTight_Gsf)'],
                'veto_triggers': [],
                'era': '2018',
                'sigma': 1.0,
