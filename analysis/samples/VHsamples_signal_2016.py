...
for v in ['ggZ', 'Z', 'Wplus', 'Wminus']:
    for m in [15, 20, 30, 40, 50, 55]:
        for ct in [0, 10, 20, 50, 100, 1000]:
            for br in ['2G2Q','4G']:
                if br=='4G':
                    suffix= "mm" #BUGS in sample naming !!!!
                else:
                    suffix='cm'                    
                samples_signal_2016['{}H{}_M{}_ctau{}_2016{}'.format(v,br,m,ct,'preVFP')] = {
                    'dataset': 'local:root://cmsxrootd.fnal.gov//store/user/gfavila/DDP/UL2016{}/{}H_HTo2LongLivedTo{}_MH-125_MFF-{}_ctau-{}{}.root'.format('preVFP',v,br, m, ct,suffix),
                ...
                samples_signal_2016['{}H{}_M{}_ctau{}_2016{}'.format(v,br,m,ct,'postVFP')] = {
                    'dataset': 'local:root://cmsxrootd.fnal.gov//store/user/gfavila/DDP/UL2016{}/{}H_HTo2LongLivedTo{}_MH-125_MFF-{}_ctau-{}{}.root'.format('postVFP',v,br, m, ct,suffix),
                    'triggers': ['(HLT_IsoMu24||HLT_IsoTkMu24||HLT_Ele27_WPTight_Gsf)'],
                    'veto_triggers': [],
                    'era': '2016postVFP',
                    'sigma': 0.46,
